...
print('Q1: the volume of a sphere with a radius of %0.2d is %0.2d' %(r,V))
...
print('Q3: the volume of a sphere with a radius of %0.2d is %0.2d' % (5, sphere_volume(5)))
...
print('Q5: The tax liability of a $63,000 income is %0.2d' %tax_liability(36000))
